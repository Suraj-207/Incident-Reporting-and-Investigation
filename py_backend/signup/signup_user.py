...
class Registration:
    ...
    def __init__(self, record):
        try:
            ...
            self.message = "Welcome to HSSERISK - Incident Reporting and Investigation. We are pleased to welcome " \
                           "your organization to our community. "
    ...
    def insert_to_db(self):
        try:
            ...
            if len(list(check_existence)) == 0:
                check_email = SendMail(self.sender_email, self.sender_password, self.user_data['_id'], self.message).send()
                if check_email:
